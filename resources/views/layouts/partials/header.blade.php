<header class="header white-bg">
        ...
        <ul class="nav top-menu">
            ...
            <li id="header_inbox_bar" class="dropdown">
                ...
                <ul class="dropdown-menu extended inbox">
                    ...
                    <li>
                        <a href="#">
                            <span class="photo"><img alt="avatar" src="{{asset('materials')}}/img/avatar-mini.jpg"></span>
                            <span class="subject">
                    ...
                    <li>
                        <a href="#">
                            <span class="photo"><img alt="avatar" src="{{asset('materials')}}/img/avatar-mini2.jpg"></span>
                            <span class="subject">
                    ...
                    <li>
                        <a href="#">
                            <span class="photo"><img alt="avatar" src="{{asset('materials')}}/img/avatar-mini3.jpg"></span>
                            <span class="subject">
                    ...
                    <li>
                        <a href="#">
                            <span class="photo"><img alt="avatar" src="{{asset('materials')}}/img/avatar-mini4.jpg"></span>
                            <span class="subject">
    ...
    <div class="top-nav ">
        ...
        <ul class="nav float-right top-menu">
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <img alt="" src="{{asset('materials')}}/img/avatar1_small.jpg">
                ...
                <ul class="dropdown-menu extended logout dropdown-menu-right">
                    ...
                    <li>
                        ...
                        this.closest('form').submit();" href=""><i class="fa fa-key"></i> Log Out</a>
                        </form>
                    </li>
                </ul>
            </li>
